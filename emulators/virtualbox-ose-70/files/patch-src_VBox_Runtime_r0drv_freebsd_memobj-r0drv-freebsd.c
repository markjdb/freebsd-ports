...
+#if __FreeBSD_version < 1500038
             ...
             vm_page_lock_queues();
@@ -210,6 +211,15 @@ DECLHIDDEN(int) rtR0MemObjNativeFree(RTR0MEMOBJ pMem)
 #if __FreeBSD_version < 1000000
...
@@ -449,7 +472,11 @@ static int rtR0MemObjFreeBSDAllocPhysPages(PPRTR0MEMOB
             {
...
@@ -462,8 +489,10 @@ static int rtR0MemObjFreeBSDAllocPhysPages(PPRTR0MEMOB
             vm_object_deallocate(pMemFreeBSD->pObject);
             rtR0MemObjDelete(&pMemFreeBSD->Core);
         }
+        IPRT_FREEBSD_RESTORE_EFL_AC();
...
@@ -486,6 +515,7 @@ DECLHIDDEN(int) rtR0MemObjNativeEnterPhys(PPRTR0MEMOBJ
                                           const char *pszTag)
 {
...
@@ -497,8 +527,10 @@ DECLHIDDEN(int) rtR0MemObjNativeEnterPhys(PPRTR0MEMOBJ
...
@@ -510,6 +542,7 @@ static int rtR0MemObjNativeLockInMap(PPRTR0MEMOBJINTER
...
@@ -519,21 +552,28 @@ static int rtR0MemObjNativeLockInMap(PPRTR0MEMOBJINTER
     if (!pMemFreeBSD)
         return VERR_NO_MEMORY;
...
@@ -573,6 +613,7 @@ static int rtR0MemObjNativeReserveInMap(PPRTR0MEMOBJIN
...
+    IPRT_FREEBSD_SAVE_EFL_AC();
     ...
     /*
@@ -631,11 +672,13 @@ static int rtR0MemObjNativeReserveInMap(PPRTR0MEMOBJIN
...
@@ -659,6 +702,8 @@ DECLHIDDEN(int) rtR0MemObjNativeMapKernel(PPRTR0MEMOBJ
...
@@ -713,6 +758,7 @@ DECLHIDDEN(int) rtR0MemObjNativeMapKernel(PPRTR0MEMOBJ
...
@@ -721,6 +767,7 @@ DECLHIDDEN(int) rtR0MemObjNativeMapKernel(PPRTR0MEMOBJ
     else
...
@@ -728,6 +775,8 @@ DECLHIDDEN(int) rtR0MemObjNativeMapUser(PPRTR0MEMOBJIN
...
+
      ...
      */
@@ -785,44 +834,50 @@ DECLHIDDEN(int) rtR0MemObjNativeMapUser(PPRTR0MEMOBJIN
...
@@ -833,7 +888,12 @@ DECLHIDDEN(int) rtR0MemObjNativeProtect(PRTR0MEMOBJINT
...
@@ -858,11 +918,19 @@ DECLHIDDEN(RTHCPHYS) rtR0MemObjNativeGetPagePhysAddr(P
...
@@ -871,11 +939,15 @@ DECLHIDDEN(RTHCPHYS) rtR0MemObjNativeGetPagePhysAddr(P
...
@@ -886,9 +958,11 @@ DECLHIDDEN(RTHCPHYS) rtR0MemObjNativeGetPagePhysAddr(P
         {
             RTHCPHYS addr;
